...
namespace MyAirport
{
...

    {
        ...
        public static readonly ILoggerFactory MyAirportLoggerFactory = LoggerFactory.Create(builder => { builder.AddConsole(); });
            ...
            //public string ConnexionString = ConfigurationManager.ConnectionStrings["MyAirportDatabase"].ConnectionString;

        static void Main(string[] args)
        {
            
           var optionsBuilder = new DbContextOptionsBuilder<MyAirportContext>();
            optionsBuilder.UseMySql(ConfigurationManager.ConnectionStrings["MyAirportDatabase"].ConnectionString);
